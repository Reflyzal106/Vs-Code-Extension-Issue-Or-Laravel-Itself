# [SOLVED] Vs-Code-Extension-Issue-Or-Laravel-Itself
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/vs-code-extension-issue-or-laravel-itself)
>
...
Check the correct usage of the where method by using parentheses to group conditions, e.g. Exam::where('user_id', $request->user()->id)->orderBy('exam_date', 'asc')->get();
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/vs-code-extension-issue-or-laravel-itself)**
